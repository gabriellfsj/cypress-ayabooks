...
describe('Teste regressivo do site Aya Books', () => {
    ...
    context('Validar página Acesse agora do site Aya Books', () => {
        ...
        it('Clicar no filtro Administrção da seção Ebooks', () => {
            acervo.selectfiltroAdministracaoBooks()
            acervo.validarSecaoAposFiltro('Administração')

        })

        it('Clicar no filtro Artes da seção Ebooks', () => {
            acervo.selectfiltroArtesBooks()
            acervo.validarSecaoAposFiltro('Artes')

        })

        it('Clicar no filtro Administrção da seção Minibooks', () => {
            acervo.selectfiltroAdministracaoMbooks()
            acervo.validarSecaoAposFiltro('Administração')

        })

        it('Clicar no filtro Artes da seção Minibooks', () => {
            acervo.selectfiltroArtesMbooks()
            acervo.validarSecaoAposFiltro('Artes')

        })

        it('Clicar no filtro Administrção da seção Audiobooks', () => {
            acervo.selectfiltroAdministracaoAbooks()
            acervo.validarSecaoAposFiltro('Administração')

        })

        it('Clicar no filtro Artes da seção Audiobook', () => {
        ...
        it('Clicar no filtro Administrção da seção Biblioteca Ebooks', () => {
            acervo.selectfiltroAdministracaoBiblioBooks()
            acervo.validarSecaoAposFiltro('Administração')

        })

        it('Clicar no filtro Artes da seção Biblioteca Ebook', () => {
        ...
        it('Clicar no filtro Administrção da seção Biblioteca Audiobooks', () => {
            acervo.selectfiltroAdministracaoBiblioAbooks()
            acervo.validarSecaoAposFiltro('Administração')

        })

        it('Clicar no filtro Artes da seção Biblioteca Audiobooks', () => {
